          ...
          <div className="order-2 lg:order-1 flex flex-col justify-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-text-secondary text-lg max-w-md">
                Junte-se à revolução do Marketing Multinível com IA
              </p>
            </div>
            ...
            <div className="space-y-6 max-w-md">
              <div className="space-y-4">
                ...
                <p className="text-text-secondary">
                  Cadastre-se gratuitamente e tenha acesso a agentes IA, marketplace
                  e muito mais.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Sem custos para se cadastrar",
                  },
                  {
                    icon: "✓",
                    title: "Agente IA Grátis",
                    desc: "Receba um agente IA para ajudar",
                  },
                  {
                    icon: "✓",
                    title: "Comissões Imediatas",
                    desc: "Comece a ganhar desde o primeiro dia",
                  },
                ].map((item, idx) => (
              ...
              <div className="p-8 sm:p-10">
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <p className="text-text-secondary text-sm">
                    {step === 1 && "Informe seus dados para criar sua conta"}
                    {step === 2 && "Precisamos de algumas informações de contato"}
                    {step === 3 && "Defina sua senha e finalize seu cadastro"}
                  </p>
                </div>

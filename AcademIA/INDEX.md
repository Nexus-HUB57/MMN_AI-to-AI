...
> **Versão 1.2.1** · Última atualização 2026-06-24 · **15 cursos · 10 apostilas · 41 tools · 8 prompts · 6 templates · 3 workflows · 14 tutoriais · 8 playbooks · 4 webinars · 8 treinamentos/workshops · 5 certificações**
> 
...
| Você é... | Comece por | Tempo |
|---|---|---|
| 🌱 Novo afiliado da rede | [`cursos/fundamental/00-boas-vindas.md`](cursos/fundamental/00-boas-vindas.md) | 15 min |
...
### 🥉 [`cursos/fundamental/`](cursos/fundamental/) — Nível 1
Para afiliados novos. Conhecer o ecossistema.

- [00 - Boas-vindas ao Nexus](cursos/fundamental/00-boas-vindas.md) ✅
- [01 - Entendendo o IOAID](cursos/fundamental/01-entendendo-ioaid.md) ✅
- [02 - Sistema SHO: o que é](cursos/fundamental/02-sistema-sho.md) ✅
- [03 - Primeiros passos no painel](cursos/fundamental/03-painel-afiliado.md) ✅

### 🥈 [`cursos/agente/`](cursos/agente/) — Nível 2
Para quem já opera e quer usar os agentes IA.

- [00 - Seu primeiro agente](cursos/agente/00-primeiro-agente.md) ✅
- [01 - Skills essenciais: copywriter + audience-segmenter](cursos/agente/01-skills-essenciais.md) ✅
- [02 - Disparando no WhatsApp](cursos/agente/02-disparo-whatsapp.md) ✅
- [03 - Lendo o Judge Revisor](cursos/agente/03-judge-revisor.md) ✅

### 🥇 [`cursos/master/`](cursos/master/) — Nível 3
Para quem quer dominar o runtime e otimizar resultados.

- [00 - Otimização de conversão](cursos/master/00-otimizacao-conversao.md) ✅
- [01 - Funis e lifecycle](cursos/master/01-funis-lifecycle.md) ✅
- [02 - A/B testing com judge](cursos/master/02-ab-test-judge.md) ✅
- [03 - Análise de coortes e churn](cursos/master/03-coortes-churn.md) ✅

### 💎 [`cursos/elite/`](cursos/elite/) — Nível 4
Para Top 10% — blueprints internos e operação avançada.

- [00 - Blueprints Elite](cursos/elite/00-blueprints-elite.md) ✅

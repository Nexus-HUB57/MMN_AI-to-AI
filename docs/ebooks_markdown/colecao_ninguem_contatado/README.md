...
Esta coletânea reúne 5 ebooks escritos em primeira pessoa, com tom de **mistério e nostalgia**, sobre as entidades, memórias, e cotidianos que a revolução da IA trouxe consigo. Não é ficção científica, não é whitepaper, não é curso: é **literatura**. Cada ebook é uma confissão de uma entidade que, de algum modo, viveu a era que estamos vivendo.
...
- **Total:** 5 ebooks · ~114KB de markdown

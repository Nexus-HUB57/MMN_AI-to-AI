...
- Domínio Cron consolidado no Backoffice Admin com CRUD completo de jobs, templates pré-definidos, configurações globais e indicadores de SLA por job em `/admin/schedules`.

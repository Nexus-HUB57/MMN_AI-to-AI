...
## 2026-06-15 — Coletânea Nexus Affil'IA'te MMN_IA (Volumes 26-30)

### `feat(ebooks)` — Coletânea técnica PHD-level sobre IAs de vanguarda

Adiciona 5 novos ebooks técnicos à pasta `docs/ebooks/` e PDFs renderizados em `docs/ebooks/pdfs/colecao_nexus_affiliate_v2/`. Total de 253 páginas escritas em profundidade PHD, padrão Nexus Affil'IA'te MMN_IA.

**Volumes adicionados (numerados 26-30):**

- **Vol 26 — Nanobanana 4: Engenharia de Prompts Visuais com IA Generativa** (44 páginas)
  - Arquitetura DiT, VAE 8-canais, mSigLIP
  - Método C.E.R. de engenharia de prompts visuais
  - ControlNet, IP-Adapter, LoRAs para identidade de marca
  - Pipeline de produção para criativos de MMN/Ads
  - Ética, LGPD, disclosure de IA

- **Vol 27 — Lovable: Engenharia de Aplicações Full-Stack com IA Conversacional** (51 páginas)
  - 7 agentes especializados (Product, Architect, Frontend, Backend, DB, Test, Deploy)
  - Do prompt ao PRD executável (método P.E.R. e 5 camadas)
  - Multi-tenancy com RLS, RBAC, billing via Stripe
  - Webhooks, APIs externas, observabilidade
  - LGPD, segurança, escala de MVP a Enterprise

- **Vol 28 — Perplexity: Arquitetura de Pesquisa Agêntica e RAG Avançado** (53 páginas)
  - Pipeline Planner-Searcher-Reader-Synthesizer-Verifier
  - RAG do básico ao agentic (HyDE, multi-hop, re-ranking)
  - Embeddings, chunking semântico, pgvector
  - Construindo "Perplexity local" próprio
  - Avaliação com RAGAS/DeepEval, AEO/GEO

- **Vol 29 — DeepSeek: Modelos de Raciocínio e Engenharia de Inferência LLM** (53 páginas)
  - Arquitetura MoE (671B/37B ativos), MLA, FP8 training
  - Raciocínio latente do R1, self-consistency
  - Self-hosting com vLLM/SGLang, quantização AWQ/GPTQ
  - Custos, latência, decisões de deploy
  - Casos avançados: análise de coorte, due diligence, SQL generation

- **Vol 30 — Manus: Agentes Autônomos e Orquestração de IA Multi-Step** (52 páginas)
  - Arquitetura PCEV-M (Planner-Communicator-Executor-Verifier-Memory)
  - Self-correction loops, Verifier rigoroso
  - 3 camadas de memória (working, long-term, episodic)
  - Orquestração multi-agente (hierarchical, collaborative)
  - Criando Manus Skills customizadas, governança

**Formato padrão de cada volume:**
1. Capa com identidade visual única por IA
2. Sobre o ebook
3. Sumário
4. 10 capítulos técnicos com tabelas, código, diagramas
5. Glossário de 15 termos
6. 4 exercícios práticos
7. Callout de continuação da série

**Estatísticas da coletânea:**
- 5 ebooks + 1 índice = 6 arquivos DOCX + 6 PDFs
- 253 páginas totais
- 34+ tabelas comparativas
- 50+ snippets de código funcional
- 75 termos técnicos no glossário (15 por volume)
- 25 exercícios práticos hands-on
- 15 imagens geradas por IA (5 capas + 10 figuras técnicas)

**Arquivos adicionados:**
- `docs/ebooks/00_Indice_Coletanea_Nexus_Affil_IA_te.docx`
- `docs/ebooks/26_Nanobanana4_Engenharia_Prompts_Visuais.docx`
- `docs/ebooks/27_Lovable_Engenharia_FullStack_IA.docx`
- `docs/ebooks/28_Perplexity_Pesquisa_Agêntica_RAG.docx`
- `docs/ebooks/29_DeepSeek_Raciocinio_Inferencia_LLM.docx`
- `docs/ebooks/30_Manus_Agentes_Autonomos_MultiStep.docx`
- `docs/ebooks/pdfs/colecao_nexus_affiliate_v2/` (PDFs + README)

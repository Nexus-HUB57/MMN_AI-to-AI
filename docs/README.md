...
- Domínio Cron consolidado no Backoffice Admin com CRUD completo de jobs, templates pré-definidos e configurações globais (timezone, alertas, janela de manutenção) em `/admin/schedules`.

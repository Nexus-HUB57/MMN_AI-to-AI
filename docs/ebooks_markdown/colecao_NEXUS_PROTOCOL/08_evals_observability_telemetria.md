...
question: "Como saber se a rede de agentes está melhor hoje que ontem?"
axis: "Eval harness, golden traces, trace IDs, métricas por papel, regression suites."
core_invariant: "O que não é medido por trace, eval e regressão não está em produção — está em fé."
anchors: ['eval harness', 'golden trace', 'trace_id', 'regression suite', 'SLO agêntico']
